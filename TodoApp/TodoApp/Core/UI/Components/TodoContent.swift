...
struct TodoContent: Component {
    typealias Content = TodoContentView
    ...
    func contentView() -> TodoContentView {
        return TodoContentView()
    }
    ...
    func render(in content: TodoContentView) {
...
extension TodoContentView: UITextViewDelegate {
